...
tf.app.flags.DEFINE_string('vocab_path', 'finished/vocab', 'Path expression to text vocabulary file.')
...
tf.app.flags.DEFINE_string('exp_name', 'myTest',
...
tf.app.flags.DEFINE_integer('max_dec_steps', 35, 'max timesteps of decoder (max summary tokens)')
...
tf.app.flags.DEFINE_integer('vocab_size', 45000,
...
def run_training(model, batcher, sess_context_manager, sv, summary_writer):
    ...
    with sess_context_manager as sess:
        ...
        while True:  # repeats until interrupted
            ...
            loss = results['loss']
            tf.logging.info('loss: %f,step: %d', loss, results['global_step'])  # print the loss to screen
...
def main(unused_argv):
    ...
    vocab = Vocab(FLAGS.vocab_path, FLAGS.vocab_size, FLAGS.embedding_path)  # create a vocabulary
